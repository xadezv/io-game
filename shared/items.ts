...
export const RECIPES: Recipe[] = [
  ...
  { result: ItemId.BIG_AXE,   count: 1, ingredients: [{ item: ItemId.WOOD, count: 30 }, { item: ItemId.STONE, count: 20 }], requiresWorkbench: false },
  { result: ItemId.BIG_PICK,  count: 1, ingredients: [{ item: ItemId.WOOD, count: 30 }, { item: ItemId.STONE, count: 20 }], requiresWorkbench: false },
  { result: ItemId.GOLD_AXE,  count: 1, ingredients: [{ item: ItemId.WOOD, count: 10 }, { item: ItemId.GOLD, count: 20 }], requiresWorkbench: false },
  { result: ItemId.GOLD_SWORD,count: 1, ingredients: [{ item: ItemId.STONE, count: 5 },{ item: ItemId.GOLD, count: 25 }], requiresWorkbench: false },
...
export interface ItemDef {
  ...
  foodThirst?: number;
  structureHp?: number;
  tempBonus?: number; // hat temp bonus
  // asset key for sprite
  sprite: string;
}
...
export const ITEMS: Record<number, ItemDef> = {
  ...
  [ItemId.STONE]:      { id: ItemId.STONE,        name: 'Stone',       stackable: true,  maxStack: 999, isWeapon: false, isStructure: false, isFood: false, isHat: false, sprite: 'stone' },
  [ItemId.GOLD]:       { id: ItemId.GOLD,         name: 'Gold',        stackable: true,  maxStack: 999, isWeapon: false, isStructure: false, isFood: false, isHat: false, sprite: 'gold_ore' },
...
// Declare missing item for TypeScript
